import numpy as npimport pandas as pandasfrom kt.dataloaders.base_loader import base_loaderfrom kt.logger import KTLogger
...
class Assistment09Loader(BaseLoader):
    ...
    def __init__(self, file_path='./dataset/assist2009/skill_builder_data_corrected.csv', load_extra_fields=True):
        ...
        self.file_path = file_path        self.fields = fields        self.dtypes = dtypes        self.load_extra_fields = load_extra_fields
